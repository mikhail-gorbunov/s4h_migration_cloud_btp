CLASS zcl_material_info_samruk DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_material_info_samruk IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA material_info TYPE REF TO zcl_material_info_samruk.
    material_info = NEW zcl_material_info_samruk(  ).
